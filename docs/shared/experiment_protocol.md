...
正式运行前确认：suite、任务集合、Clean seed 数、Plus variant 数与 runnable/skipped 数、checkpoint/stats hash、五类扰动、easy/medium/hard 映射、未分级记录处理、max steps、control horizon、3 个 GPU、视频策略和输出目录。完整门禁见 [实施与验收手册](../thought1/execution_guide.md)。
