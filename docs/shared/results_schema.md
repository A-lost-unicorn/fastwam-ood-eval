...
文件。完整流程见
[thought2_blind_review_and_sampling.md](../thought2/blind_review_and_sampling.md)。
...
[thought2_statistical_analysis_plan.md](../thought2/statistical_analysis_plan.md)；
...
[thought2_static_calibration.md](../thought2/static_calibration.md)。
