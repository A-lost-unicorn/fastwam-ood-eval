...
> [v1 失败报告](phase_e9_v1_failure_report.md)；修复后的唯一入口和
> 不变科学边界见 [E.9a-v2 协议](phase_e9_v2_protocol.md)，实际
> 四轨状态见 [E.9a-v2 结果](phase_e9_v2_report.md)。
...
执行，其状态以 [E.9a-v2 结果](phase_e9_v2_report.md)为准。
