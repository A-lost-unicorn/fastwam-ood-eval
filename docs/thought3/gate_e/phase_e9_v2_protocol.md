...
> 工件 SHA 见 [E.9a-v2 结果报告](phase_e9_v2_report.md)。以下设计
> 内容保留为运行前冻结协议，不因结果改写。
...
[v1 失败报告](phase_e9_v1_failure_report.md)。
...
[v1 归档协议](phase_e9_protocol.md)。不得选择 step 100，不得降低
...
[E.9a-v2 结果报告](phase_e9_v2_report.md)为准；它们仍不证明
