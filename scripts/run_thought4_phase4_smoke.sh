...
status_path="${project_root}/outputs/thought4/phase4_geometry_action_smoke_v4/run_status.json"
...
output_root="${project_root}/outputs/thought4/phase4_geometry_action_smoke_v4"
